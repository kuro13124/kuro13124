...
namespace Demo_1.Class
{
    internal class Functions
    {
        ...
        {
            Con = new SqlConnection();   //Khởi tạo đối tượn
            Con.ConnectionString = @"Data Source=DESKTOP-GNV9926\SQLEXPRESS;Initial Catalog=QuanLyBangHang;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
